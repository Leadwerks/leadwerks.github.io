                    ...
                    if (d.length >= set.minimumLength)
                    {
                         if (standard)
                         {
                              ...
                              for (var i = 0; i < tipuesearch.pages.length; i++)
                              {
                                   ...
                                   var ltitle = tipuesearch.pages[i].title.toLowerCase();
                                   if (ltitle == d)
                                   {
                                        score += 10000;
                                   }
                                   else if (ltitle.slice(0, d.length + 1) == d.concat(" "))
                                   {
                                        score += 5000;
                                   }
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   if (l_o >= start && l_o < set.show + start)
                                   {
                                        ...
                                        if (set.showURL)
                                        {
                                             var s_u = found[i].url.toString();//.toLowerCase();
                                             if (s_u.indexOf('http://') == 0)
                                             {
                                                  s_u = s_u.slice(7);
                                             }
                                             var paramsstart = s_u.indexOf('?');
                                             if (paramsstart != -1)
                                             {
                                                  s_u = s_u.slice(0,paramsstart);
                                             }                                                                                        
